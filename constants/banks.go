...
var BanksMap = map[BankKey]Bank{
	BankKey_ABBANK: {
		...
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("ABBKVNVX"),
		Keywords:        utils.StrPtr("anbinh"),
	},
	BankKey_ACB: {
		Key:             BankKey_ACB,
		Code:            BankCode_ACB,
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("ASCBVNVX"),
		Keywords:        utils.StrPtr("achau"),
	},
	BankKey_AGRIBANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("VBAAVNVX"),
		Keywords:        utils.StrPtr("nongnghiep, nongthon, agribank, agri"),
	},
	BankKey_BAC_A_BANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("NASCVNVX"),
		Keywords:        utils.StrPtr("baca, NASB"),
	},
	BankKey_BAOVIET_BANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("BVBVVNVX"),
		Keywords:        utils.StrPtr("baoviet, BVB"),
	},
	BankKey_BANVIET: {
		Key:             BankKey_BANVIET,
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("VCBCVNVX"),
		Keywords:        utils.StrPtr("banviet, vietcapitalbank"),
	},
	BankKey_BIDC: {
		Key:          BankKey_BIDC,
		Code:         BankCode_BIDC,
	...
	BankKey_BIDV: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("BIDVVNVX"),
	},
	BankKey_CAKE: {
		Key:             BankKey_CAKE,
		Code:            BankCode_CAKE,
	...
	BankKey_CBBANK: {
		...
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("GTBAVNVX"),
		Keywords:        utils.StrPtr("xaydungvn, xaydung"),
	},
	BankKey_CIMB: {
		Key:             BankKey_CIMB,
		Code:            BankCode_CIMB,
		...
		VietQRStatus:    VietQRReceiveOnly,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("CIBBVNVN"),
		Keywords:        utils.StrPtr("cimbvn"),
	},
	BankKey_COOP_BANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		Keywords:        utils.StrPtr("hoptacxa, coop"),
	},
	BankKey_DBS_BANK: {
		...
		ShortName:       "DBS Bank",
		VietQRStatus:    VietQRReceiveOnly,
		LookupSupported: utils.IntPtr(0),
		SWIFTCode:       utils.StrPtr("DBSSVNVX"),
		Keywords:        utils.StrPtr("dbshcm"),
	},
	BankKey_DONG_A_BANK: {
		...
		VietQRStatus:    VietQRReceiveOnly,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("EACBVNVX"),
		Keywords:        utils.StrPtr("donga, DAB"),
	},
	BankKey_EXIMBANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("EBVIVNVX"),
	},
	BankKey_GPBANK: {
		Key:             BankKey_GPBANK,
		...
		VietQRStatus:    VietQRReceiveOnly,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("GBNKVNVX"),
		Keywords:        utils.StrPtr("daukhi"),
	},
	BankKey_HDBANK: {
		Key:             BankKey_HDBANK,
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("HDBCVNVX"),
	},
	BankKey_HONGLEONG_BANK: {
		...
		VietQRStatus:    VietQRReceiveOnly,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("HLBBVNVX"),
		Keywords:        utils.StrPtr("HLBVN"),
	},
	BankKey_HSBC: {
		Key:             BankKey_HSBC,
		Code:            BankCode_HSBC,
		...
		VietQRStatus:    VietQRReceiveOnly,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("HSBCVNVX"),
	},
	BankKey_IBK_HCM: {
		Key:             BankKey_IBK_HCM,
		...
		VietQRStatus:    VietQRReceiveOnly,
		LookupSupported: utils.IntPtr(0),
		Keywords:        utils.StrPtr("congnghiep"),
	},
	BankKey_IBK_HN: {
		Key:             BankKey_IBK_HN,
	...
	BankKey_KASIKORN_BANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("KASIVNVX"),
	},
	BankKey_KIENLONG_BANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("KLBKVNVX"),
	},
	...
	BankKey_LIENVIETPOST_BANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("LVBKVNVX"),
		Keywords:        utils.StrPtr("lienvietbank"),
		Deprecated:      utils.BoolPtr(true),
	},
	BankKey_LPBANK: {
		Key:             BankKey_LPBANK,
		...
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("LVBKVNVX"),
		Keywords:        utils.StrPtr("lienvietbank, loc phat"),
	},
	BankKey_LIOBANK: {
		Key:             BankKey_LIOBANK,
	...
	BankKey_MBBANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("MSCBVNVX"),
	},
	BankKey_MBV: {
		Key:             BankKey_MBV,
		Code:            BankCode_MBV,
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("OCBKUS3M"),
		Keywords:        utils.StrPtr("daiduong, mbv"),
	},
	BankKey_MSB: {
		Key:             BankKey_MSB,
		Code:            BankCode_MSB,
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("MCOBVNVX"),
		Keywords:        utils.StrPtr("hanghai"),
	},
	BankKey_NAM_A_BANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("NAMAVNVX"),
		Keywords:        utils.StrPtr("namabank"),
	},
	BankKey_NCB: {
		Key:             BankKey_NCB,
		Code:            BankCode_NCB,
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("NVBAVNVX"),
		Keywords:        utils.StrPtr("quocdan"),
	},
	...
	BankKey_OCB: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("ORCOVNVX"),
		Keywords:        utils.StrPtr("phuongdong"),
	},
	BankKey_OCEANBANK: {
		...
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("OCBKUS3M"),
		Keywords:        utils.StrPtr("daiduong"),
		Deprecated:      utils.BoolPtr(true),
	},
	BankKey_PGBANK: {
		Key:             BankKey_PGBANK,
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("PGBLVNVX"),
	},
	BankKey_PUBLIC_BANK: {
		...
		VietQRStatus:    VietQRReceiveOnly,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("VIDPVNVX"),
		Keywords:        utils.StrPtr("publicvn"),
	},
	BankKey_PVCOM_BANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("WBVNVNVX"),
		Keywords:        utils.StrPtr("daichung"),
	},
	BankKey_SACOMBANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("SGTTVNVX"),
	},
	BankKey_SAIGONBANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("SBITVNVX"),
		Keywords:        utils.StrPtr("saigoncongthuong, saigonbank"),
	},
	BankKey_SCB: {
		Key:             BankKey_SCB,
		Code:            BankCode_SCB,
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("SACLVNVX"),
		Keywords:        utils.StrPtr("saigon"),
	},
	BankKey_SEA_BANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("SEAVVNVX"),
	},
	BankKey_SHB: {
		Key:             BankKey_SHB,
		Code:            BankCode_SHB,
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("SHBAVNVX"),
		Keywords:        utils.StrPtr("saigonhanoi, sghn"),
	},
	BankKey_SHINHAN_BANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("SHBKVNVX"),
	},
	BankKey_STANDARD_CHARTERED_BANK: {
		...
		VietQRStatus:    VietQRReceiveOnly,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("SCBLVNVX"),
	},
	BankKey_TECHCOMBANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("VTCBVNVX"),
	},
	BankKey_TIMO: {
		Key:             BankKey_TIMO,
		Code:            BankCode_TIMO,
	...
	BankKey_TPBANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("TPBVVNVX"),
		Keywords:        utils.StrPtr("tienphong"),
	},
	BankKey_UBANK: {
		Key:             BankKey_UBANK,
		Code:            BankCode_UBANK,
	...
	BankKey_VIB: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("VNIBVNVX"),
		Keywords:        utils.StrPtr("quocte"),
	},
	BankKey_VIET_A_BANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("VNACVNVX"),
	},
	BankKey_VIET_BANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("VNTTVNVX"),
		Keywords:        utils.StrPtr("vietnamthuongtin, vnthuongtin"),
	},
	BankKey_VIETCOMBANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("BFTVVNVX"),
	},
	BankKey_VIETINBANK: {
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("ICBVVNVX"),
		Keywords:        utils.StrPtr("viettin"), // Some users may use this Keyword
	},
	BankKey_VIKKI: {
		Key:             BankKey_VIKKI,
		Code:            BankCode_VIKKI,
		...
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("EACBVNVX"),
		Keywords:        utils.StrPtr("vikki, dongabank, dong a"),
	},
	BankKey_VPBANK: {
		Key:             BankKey_VPBANK,
		...
		VietQRStatus:    VietQRTransferSupported,
		LookupSupported: utils.IntPtr(1),
		SWIFTCode:       utils.StrPtr("VPBKVNVX"),
		Keywords:        utils.StrPtr("vnthinhvuong"),
	},
	BankKey_VRB: {
		Key:             BankKey_VRB,
		Code:            BankCode_VRB,
		...
		VietQRStatus:    VietQRReceiveOnly,
		LookupSupported: utils.IntPtr(1),
		Keywords:        utils.StrPtr("vietnam-russia, vrbank"),
	},
	BankKey_WOORI_BANK: {
